            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" summary="" width="640">
                ...
                <tr>
                    <td align="center" class="logoContainer">
                        <a href="http://www.mikant.com" title="MikAnt"><img alt="logo" class="logo"
                                                                            src="{{asset('images/imglogoSinfondoPequenia.png')}}"></a>
                    </td>
                </tr>
                </tbody>
            </table>
...
<table border="0" cellpadding="0" cellspacing="0" class="featuredHeader" style="background-color: #084b8a;" summary=""
       width="100%">
    <tbody>
    <tr>
...
<p><span style="display: block;"><span style="display: block;"><span
                    style="color: #ffffff;"><!-- End featuredHeader --></span> <!-- Section --></span></span></p>
                    ...
                    <td class="sectionSubTitle" style="height: 106px;">
                        ...
                        <table style="height: 172px; width: 296px; margin-left: auto; margin-right: auto;">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; width: 244px;"><strong><a href="mailto:info@mikant.com">info@mikant.com</a></strong>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 36px; text-align: center;"><img alt="logo" class="logo"
                                ...
                                <td style="width: 244px; text-align: center;"><strong><a
                                                href="mailto:neri022@hotmail.com">neri022@hotmail.com</a></strong></td>
                            </tr>
                            <tr>
                                <td style="width: 36px; text-align: center;"><img alt="logo" class="logo"
...
<p><span style="display: block;"><span style="display: block;"><!-- End Section --> <!-- Social media --></span></span>
</p>
<table border="0" cellpadding="0" cellspacing="0" class="socialMedia" style="background-color: #084b8a;" summary=""
       width="100%">
    <tbody>
    <tr>
