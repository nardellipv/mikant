...
@section('content')
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <!-- Basic layout-->
            {!! Form::open(['method' => 'POST','route' => ['payment.store'],'class'=>'form-horizontal']) !!}
            {{ csrf_field() }}
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    ...
                    <div class="text-right">
                        <button type="submit" class="btn btn-primary">Crear método de pago <i class="icon-arrow-right14 position-right"></i></button>
                    </div>
                </div>
            </div>
        {!! Form::Close() !!}
