    ...
    <div class="content">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                {!! Form::model($blog, ['method' => 'PATCH','route' => ['blog.update', $blog->id],'enctype' => 'multipart/form-data']) !!}
                {{ csrf_field() }}
                ...
                <div class="content-group">
                    ...
                    <textarea name="body" id="body" rows="4" cols="4">{{ $blog->body }}</textarea>
                </div>
                <div class="text-right">
                    <button type="submit" class="btn bg-teal-400">Salvar
