...
@section('content')
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <!-- Basic layout-->
            {!! Form::open(['method' => 'POST','route' => ['projects.store'],'class'=>'form-horizontal']) !!}
            {{ csrf_field() }}
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <textarea rows="3" cols="5" name="observation" class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary">Crear Proyecto <i
