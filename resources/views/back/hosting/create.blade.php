...
@section('content')
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            {!! Form::open(['method' => 'POST','route' => ['backhosting.store'],'class'=>'form-horizontal']) !!}
            {{ csrf_field() }}
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" name="data_base" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" name="year_pay">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Cost Before:</label>
                        <div class="col-lg-9">
                            <del><input type="text" class="form-control" name="cost_before"></del>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="text-right">
                        <button type="submit" class="btn btn-primary">Crear hosting <i
